...
export interface AccountManagerSummaryField {
	...
	wValue: AccountManagerInfoWatchedValue;
	/**
...
export interface AccountManagerSummaryValues {
	equity: AccountManagerInfoWatchedValue;
	balance: AccountManagerInfoWatchedValue;
	totalProfit: AccountManagerInfoWatchedValue;
}
/**
...
export type AccountManagerInfoWatchedValue = IWatchedValueReadonly<any>;
/**
